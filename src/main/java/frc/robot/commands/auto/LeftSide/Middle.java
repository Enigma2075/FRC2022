...
public class Middle extends SequentialCommandGroup{
    ...
    public Middle(GyroSubsystem gyro, DriveSubsystem drive, ShooterSubsystem shooter, IndexerSubsystem indexer, IntakeSubsystem intake) {
        this.drive = drive;
        ...
        startPose = new Pose2d(0, -85.5, Math.toRadians(90));
