...
public class LeftTwoCargo extends SequentialCommandGroup{
    ...
    public LeftTwoCargo(GyroSubsystem gyro, DriveSubsystem drive, ShooterSubsystem shooter, IndexerSubsystem indexer, IntakeSubsystem intake) {
        this.drive = drive;
